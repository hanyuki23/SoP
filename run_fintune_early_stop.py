...
import os
import torch
from exp.early_stop_v0_ijcai import Exp_Long_Term_Forecast
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cseg_len', type=int, default=48,
                        help='the length of segmentation')
    ...
    parser.add_argument('--lradj', type=str, default='int', help='adjust learning rate')
...
>>>>>>> d162c8d4752e7083fd44d7c660f8f25bc5ce67f4
    ...
    parser.add_argument('--unfreeze_layers', type=int, default=1, help='unfreeze layers')
    parser.add_argument('--cluster', type=list, default=[], help='plug cluster')
